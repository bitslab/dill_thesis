...
\end{figure}
Like \textit{Gepard} and \textit{FFWD} dedicated delegation utilizes threads acting exclusively as clients or servers. 
...
\label{fig:flat_delegation}
\end{figure}
On the other hand, threads in flat delegation serve as both clients and servers. 
